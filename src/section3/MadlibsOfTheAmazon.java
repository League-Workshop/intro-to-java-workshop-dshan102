...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String sentence = JOptionPane.showInputDialog("Piranhas are more" + " " + adjective + " " + "during the day, so cross the river at night."
		+ " " + "Piranhas are attracted to fresh" + " " + liquid + " " + "and will most likely bite out of your" + " " + body_part + " " + "if you" + " " + verb
